...
Func gauss_down2(Func input) {
    ...
    k(x,y) = 0;
    k(0, 0) = 4;
    k(-1, -1) = k(-1, 1) = k(1, -1) = k(1, 1) = 1;
    k(-1,  0) = k( 0, 1) = k(0, -1) = k(1, 0) = 2;
...
Func gauss_down4(Func input) {
    ...
    Func k;
    k(x,y) = 0;
    k(-2,-2) = k(2,-2) = k(-2, 2) = k(2, 2) = 1;
    k(-1,-2) = k(1,-2) = k(-2,-1) = k(2,-1) = k(-2, 1) = k(2, 1) k(-1, 2) = k(1, 2) = 4;
    k(0,-2) = k(-2, 0) = k(2, 0) = k(0, 2) =  6;
    k(-1,-1) = k(1,-1) = k(-1, 1) = k(1, 1) = 16;
    k(0,-1) = k(-1, 0) = k(1, 0) = k(0, 1) = 24;
    k(0, 0) = 36;
...
Func align(Image imgs) {
    Func layer_0 = box_down2(Func(imgs));
    Func layer_1 = gauss_down2(L1);
    Func layer_2 = gauss_down4(layer_1);
    Func layer_3 = gauss_down4(layer_2);

    // TODO: implement a lot of stuff for alignment...

    Func alignment(imgs->name() + "_alignment");    // will have the dimmensionality: coordinate (0 or 1) * tile_x * tile_y * alternate image index
    return alignment;
}