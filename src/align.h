...
#define MIN_OFFSET                                                             \
  -168 // Min total alignment (based on three levels and downsampling by 4)
#define MAX_OFFSET                                                             \
  126 // Max total alignment. Differs from MIN_OFFSET because total search range
      // is 8 for better vectorization
